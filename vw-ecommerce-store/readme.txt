...
= 1.0 =
* Added go pro button in slider, best seller and footer section in customizer.
...
* Show/ hide slider image opacity in customizer.
* Updated language folder. 
...
* Resolved error for blog post button.
...
== Fonts ==
* Fira+Sans *
* Source : https://fonts.google.com/specimen/Fira+Sans?query=Fira+Sans
...
== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-ecommerce-store/