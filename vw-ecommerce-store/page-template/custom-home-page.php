...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_ecommerce_store_slider_hide_show', false) == 1 || get_theme_mod( 'vw_ecommerce_store_resp_slider_hide_show', true) == 1) { ?>

    <section id="slider">
      <?php if(get_theme_mod('vw_ecommerce_store_slider_type', 'Default slider') == 'Default slider' ){ ?>
      <div class="container">
        <div class="row">
                  ...
                  <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
                    ...
                    <div class="carousel-caption">
                      <div class="inner_carousel">
                        ...
                        <p class="wow slideInRight delay-1000" data-wow-duration="2s"><?php $vw_ecommerce_store_excerpt = get_the_excerpt(); echo esc_html( vw_ecommerce_store_string_limit_words( $vw_ecommerce_store_excerpt, esc_attr(get_theme_mod('vw_ecommerce_store_slider_excerpt_number','30')))); ?></p>
                        <?php if( get_theme_mod('vw_ecommerce_store_slider_button_text','SHOP NOW') != ''  || get_theme_mod('vw_ecommerce_store_slider_button_link') != ''){ ?>
                          <div class="slider-btn wow slideInRight delay-1000" data-wow-duration="2s">
                            <a href="<?php echo esc_url(get_theme_mod('vw_ecommerce_store_slider_button_link','')); ?>"><?php echo esc_html(get_theme_mod('vw_ecommerce_store_slider_button_text',__('SHOP NOW','vw-ecommerce-store')));?><span class="screen-reader-text"><?php echo esc_html(get_theme_mod('vw_ecommerce_store_slider_button_text',__('SHOP NOW','vw-ecommerce-store')));?></span></a>
                          </div>
                        <?php } ?>
                      </div>
                    </div>
      ...
      <div class="clearfix"></div>
        <?php } else if(get_theme_mod('vw_ecommerce_store_slider_type', 'Advance slider') == 'Advance slider'){?>
          <?php echo do_shortcode(get_theme_mod('vw_ecommerce_store_advance_slider_shortcode')); ?>
        <?php } ?>
    </section>
