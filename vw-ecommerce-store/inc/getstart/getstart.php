...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
			...
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($vw_ecommerce_store_plugin_custom_css); ?>">
				<div class="block-pattern-img">
					...
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','vw-ecommerce-store'); ?></p>
	              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon.','vw-ecommerce-store'); ?></span></b></p>
				    ...
				    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/block-pattern1.png" alt="" />
				    	<p><b><?php esc_html_e('Click on Patterns Tab >> Click on Theme Name >> Click on Sections >> Publish.','vw-ecommerce-store'); ?></span></b></p>
		...
		<div id="gutenberg_editor" class="tabcontent">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Gutunberg Block', 'vw-ecommerce-store' ); ?></h3>
				<hr class="h3hr">
				<div class="vw-ecommerce-store-pattern-page">
		...
		<div id="product_addons_editor" class="tabcontent">
			<?php if(!class_exists('IEPA_Loader')){
				$plugin_ins = VW_Ecommerce_Store_Plugin_Activation_Woo_Products::get_instance();
				$vw_ecommerce_store_actions = $plugin_ins->recommended_actions;
				?>
				<div class="vw-ecommerce-store-recommended-plugins">
					    <div class="vw-ecommerce-store-action-list">
			...
			<?php }else{ ?>
				...
				<div class="vw-ecommerce-store-pattern-page">
					...
					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','vw-ecommerce-store'); ?></span></b></p>
	              	<div class="vw-ecommerce-store-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-woocommerce-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vw-ecommerce-store'); ?></a>
			    	</div>
	              	<p><?php esc_html_e('You can create a template as you like.','vw-ecommerce-store'); ?></span></p>
			    </div>
			<?php } ?>
		</div>
